 ...
 *
 * Based on the work by st.john.johnson@gmail.com and jeremiah.wuenschel@gmail.com
 */
...
def installed() {
    log.debug "SmartApp MQTT Bridge Installed with settings: ${settings}"
...
def updated() {
    log.debug "SmartApp MQTT Bridge Updated with settings: ${settings}"
...
def updateSubscription() {
    ...
    log.debug "SmartApp MQTT Bridge Updating subscription: ${json}"
...
def bridgeHandler(evt) {
    ...
    log.debug "SmartApp MQTT Bridge:bridgeHandler. Received device event from bridge: ${json}"
...
def inputHandler(evt) {
    ...
    log.debug "SmartApp MQTT Bridge:inputHandler: Forwarding device event to bridge: ${json}"
    bridge.deviceNotification(json)
}
...
def actionUpdateSensor (device, attribute, value) {
	switch (attribute) {
    	case "temperature":
